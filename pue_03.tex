...
\begin{itemize}
    ...
    \item $\Delta c_t = 0.7 + 0.6t + \Delta u_t$, $\Delta^2 c_t = 0.6 + \Delta^2 u_t$
\end{itemize}
}
...
\begin{itemize}
    ...
    \item $\Var(a_t) = 1$, $\Var(\Delta a_t) = 2$, $\Var(\Delta^2 a_t) = 4$

    \item $\E(b_t) = 3 + 0.4t$, $\E(\Delta b_t) = 0.4$, $\E(\Delta^2 b_t) = 0$
    \item $\Var(b_t) = 1$, $\Var(\Delta b_t) = 2$, $\Var(\Delta^2 b_t) = 4$

    \item $\E(c_t) = 3 + 0.4t + 0.3t^2$, $\E(\Delta c_t) = 0.7 + 0.6t$, $\E(\Delta^2 c_t) = 0.6$
    \item $\Var(c_t) = 1$, $\Var(\Delta c_t) = 2$, $\Var(\Delta^2 c_t) = 4$
\end{itemize}
}
